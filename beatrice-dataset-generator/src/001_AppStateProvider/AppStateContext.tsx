...
type Action =
  ...
  | {
      type: typeof ActionTypes.TOGGLE_CHARACTER_SELECTION;
      payload: { id: string };
    }
  | {
  ...
  switch (action.type) {
    ...
    case ActionTypes.DELETE_CHARACTER:
      return {
        ...
        selectedCharacterId:
          state.selectedCharacterId === action.payload.id
            ? null
      ...
      return {
        ...
        characters: state.characters.map((character) =>
          character.id === action.payload.characterId
            ? {
                ...character,
                audioFiles: character.audioFiles.map((file) =>
      ...
      return {
        ...
        characters: state.characters.map((character) =>
          character.id === action.payload.characterId
            ? {
                ...character,
                audioFiles: character.audioFiles.filter(
...
export const AppStateProvider = ({ children }: AppStateProviderProps) => {
  ...
  const toggleCharacterSelection = (id: string) => {
    dispatch({ type: ActionTypes.TOGGLE_CHARACTER_SELECTION, payload: { id } });
  };
